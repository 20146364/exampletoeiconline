...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <fmt:bundle basename="AplicationResources">
                        <div class="table-responsive">
                            <display:table id="tableID" name="items.list" partialList="true" size="${items.totalItem}"
                                           pagesize="${items.maxPageItem}" sort="external"
                                           class="table table-fcv-ace table-striped table-bordered table-hover dataTable no-footer"
                                           style="margin: 3em 0 1.5em;">
                                <display:column property="titleName" titleKey="label.guideline.title" sortable="true"></display:column>
                                <display:column property="content" titleKey="label.guideline.content" sortable="true"></display:column>
                            </display:table>
                        </div>
                    </fmt:bundle>
                </div>
